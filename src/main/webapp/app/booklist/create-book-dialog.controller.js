(function() {
    ...
    BookCreateController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Book'];

    function BookCreateController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Book) {
        var vm = this;
